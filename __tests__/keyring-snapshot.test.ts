...
/**
 * Phase 1 Day 5 lock-in: 1 mnemonic → all 10 supported chain addresses.
 * Any future derivation change (different lib version, path, curve params)
 * will break this snapshot — by design. Verify the diff is intentional
 * before regenerating with `jest -u`.
 */
